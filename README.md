...
The BC User Research Guide provides documentation and instruction on doing design research as a BC public servant. The [draft version of the guide](https://bcgov.github.io/user-research-guide/) is being developed in Github and can be read using Github pages
